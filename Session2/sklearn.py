...
def clustering_with_KMeans():
    data, labels = load_data(data_path='20news-bydate/20news-full-processed.txt')
    X = csr_matrix(data)
    print('='*20)
    kmeans = KMeans(
        n_clusters=20,
...
def classifying_with_linear_SVMs():
    train_X, train_y = load_data('20news-bydate/20news-train-processed.txt')
    ...
    test_X, test_y = load_data('20news-bydate/20news-test-processed.txt')
