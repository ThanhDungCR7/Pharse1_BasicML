from const import MAX_DOC_LENGTH, unknown_ID, padding_ID
...
encode_data('Session4/w2v/20news-train-raw.txt', 'Session 4/w2v/vocab-raw.txt')
encode_data('Session4/w2v/20news-test-raw.txt', 'Session 4/w2v/vocab-raw.txt')