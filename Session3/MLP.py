...
def load_dataset():
    train_data_reader = DataReader(
        data_path = '20news-bydate/20news-train-processed.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
    test_data_reader = DataReader(
        data_path = '20news-bydate/20news-test-processed.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
...
if __name__ == '__main__':
    ...
    with open('20news-bydate/data_tf_idf.txt') as f:
    ...
    with tf.Session() as sess:
        ...
        with open('Session3/log.txt', 'a') as f:
            while step < MAX_STEP:
    ...
    test_data_reader = DataReader(
        data_path = '20news-bydate/words_idfs.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
    with tf.Session() as sess:
